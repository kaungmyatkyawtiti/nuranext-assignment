  ...
  return (
    <main className="min-h-screen px-8 md:px-12 lg:px-20 col-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-8 w-full">
        ...
        <div>
          <h1 className="text-[clamp(1.5rem,6vw,50px)] font-bold leading-tight mb-3">
            {`Let's`} <span className="text-brand-primary">Connect.</span>
          </h1>
          <p className="text-[clamp(15px,4vw,1.2rem)] text-foreground/80 max-w-md leading-relaxed">
